    ...
    Localization = {
        ...
        Translations = {
            zh = {
                ...
                ["DEBUG Mode: Error"] = "调试模式：错误",
                ["Failed to verify integrity."] = "验证完整性失败。",
                ["Key is invalid."] = "密钥无效。",
                ["You are being rate limited, please wait 20 seconds and try again."] = "操作过于频繁，请等待20秒后重试。",
                ["Server returned an invalid status code, please try again later."] = "服务器返回错误状态码，请稍后重试。",
